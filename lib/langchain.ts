...
async function fetchMessageFromDb(docId: string) {
  ...
  // format langchain can recognise
  // langchain needs to know am I ai or human
  ...
  console.log(
    `--- fetched last ${chatHistory.length} messages sucessfully ---`
  );
...
const generateLangchainCompletion = async (docId: string, question: string) => {
  ...
  const historyAwareRetrievalPrompt = ChatPromptTemplate.fromMessages([
    ...
    ...chatHistory, // Inser the actual chat history here
...
// Export the model and the run functon
