...
const features = [
  {
    ...
    description:
      "Keep all your important PDF files securely stored and easily asscessible anytime, anywhere.",
    icon: GlobeIcon,
  },
  {
    name: "Blazing Fast Responses",
    description:
      "Experience lightening-fast answer to your queries, ensuring you get the information you need instantly.",
    icon: ZapIcon,
  },
  {
  ...
  {
    name: "Interactive PFF Viewer",
    description:
      "Engage with your PDFs like never before using our intuitive and intereactive viewer.",
    icon: EyeIcon,
  },
  {
    name: "Cloud Backup",
    description:
      "Rest assured knowing your document are safely backed up on the cloud, protected from loss or damage.",
    icon: ServerCogIcon,
  },
  {
